...
import org.firstinspires.ftc.teamcode.supers.OpModeState;
...
public class TargetingTeleOpTest extends LinearOpMode {
    ...
    private boolean lastDDown = false, lastLBumper = false, lastRBumper = false, lastX = false, lastB = false, lastY = false, clawPos = false;
    ...
    public void runOpMode() throws InterruptedException{
        ...
        while(isStarted() && !isStopRequested()){
            ...
            switch(robot.getState()){
                case STANDARD:
                    // continue with normal universal actions
                    // Mecannum math
                ...
                case TARGETING:
                    ...
                    if(robot.odo.alignAndCheckShot(Target.TOP)) telemetry.addData("Current target aligned: ", Target.TOP);
                    else telemetry.addData("Current target invalid: ", Target.TOP);
            ...
            if(gamepad1.y && !lastY){
                robot.switchState(robot.getState() == OpModeState.STANDARD ? OpModeState.TARGETING : OpModeState.STANDARD);
            }
            lastY = gamepad1.y;
        }
    }
